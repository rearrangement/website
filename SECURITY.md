...
| ^5.1.0 (Spirit)   | ✅        | N/A                     |
| 4.2.4             | ✅        | 01/2026                 |
| ^4.0.0 (Glowsickle) | :x:      | 10/2025                  |
| ^3.0.0            | :x:       | 06/2025                 |
| ^2.0.0 (Leet)     | :x:       | 04/2024
| ^1.0.0            | :x:       | 05/2021                 |
...
Anything that allows people to send links to my website and control other peoples computer via leaking information or sending malicious software.

Eventually I do want to have a download server here, some vulnerabilites that could be reported are people uploading files to MY server without permission, finding vulnerabilities that allow RCE on the server's host and such.
